 ...
 *
 * Shows quick-access cards for all Plex modules, including paywall-gated ones.
 */
...
export default function PlexModuleGrid({
  ...
  return (
    <div className="grid grid-cols-2 gap-3 text-left">
      ...
      {/* DocuLegal (paywall-gated for gratuit/basique) */}
      <button
        onClick={() => {
          if (isLocked) {
            setVista("dashboard");
      ...
      {/* Gestion Immobilière — shows live vacancy stats */}
      ...
      {/* Assistant IA (full-width, paywall-gated on gratuit) */}
