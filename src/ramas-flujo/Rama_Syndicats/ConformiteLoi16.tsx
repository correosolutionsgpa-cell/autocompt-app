 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Rama: Rama_Syndicats
 * Extraído de: src/App.tsx (L22523–L22573) — Fase 4 del desmantelamiento modular
 *
 * Shell wrapper para SyndicLoi16View (ya modularizado).
 * Sin estados propios — componente presentacional puro.
 *
 * Nota Legal (Loi 16 — Golden Rule §2):
 *   SyndicLoi16View implementa el ledger inmutable exigido por la Loi 16
 *   (registros append-only, inmutables, con timestamp criptográfico).
 *   Este shell NO modifica esa lógica en ninguna forma.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
export interface ConformiteLoi16Props {
  darkMode: boolean;
  adminName: string;
  adminRole: string;
  adminPhoto: string;
...
const ConformiteLoi16: React.FC<ConformiteLoi16Props> = ({
  darkMode,
  adminName,
  adminRole,
  adminPhoto,
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="text-left">
          ...
          <h1 className="font-black uppercase italic tracking-tighter text-base sm:text-lg mt-0.5">
            Conformité Loi 16 - Carnet d'entretien
          </h1>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center gap-2.5 bg-slate-50/50 dark:bg-zinc-900/40 p-1.5 pr-3 rounded-full border border-slate-150 dark:border-zinc-800 shadow-sm hover:border-violet-500/30 transition-all cursor-pointer">
          ...
          <div className="text-left hidden sm:block">
            ...
            <p className="text-[7px] font-bold uppercase text-violet-500 tracking-wider mt-0.5 leading-none">
              {adminRole}
            </p>
          </div>
        </div>
...
export default ConformiteLoi16;
